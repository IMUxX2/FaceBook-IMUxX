...
def ceknet():
    try:
    	os.system('reset')
        print internet
        print '\r\033[37;1m[\x1b[92m+\033[37;1m] \033[37;1mCheck your internet connection'
        time.sleep(2)
        toolbar_width = 25
    	...
    	time.sleep(3.5)
        exit('\n\033[37;1m[\x1b[92mx\033[37;1m] \033[31;1mThe program stops\n')
...
def start():
        try:
            ...
            print '\033[37;1m[\033[32;1mx\033[37;1m] \033[37;1mMissing word list title'
            print '\033[37;1m[\033[32;1mx\033[37;1m] \033[37;1mI suggest you do it yourself'
            sys.exit()
